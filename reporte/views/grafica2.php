          ...
          <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
            ...
            <li class="nav-item menu-open">
              ...
              <ul class="nav nav-treeview">
                <li class="nav-item">
                  <a onclick="CargarContenido('content-wrapper','estadisticos.php')" class="nav-link active" style="cursor:pointer;">
                    <i class="far fa-circle nav-icon"></i>
                    <p>Gráficos Estadísticos</p>
                  </a>
                </li>
                <li class="nav-item">
                  <a onclick="CargarContenido('content-wrapper','reportes.php')" class="nav-link active" style="cursor:pointer;">
                    <i class="far fa-circle nav-icon"></i>
                    <p>Reportes</p>
                  </a>
                </li>
            ...
            <div class="col-lg-6">
              <div class="card">
                <div class="card-body">
                  ...
                  <p class="card-text">
                    El grafico se realizo con la cantidad de clientes inscritos
                  </p>

                  <a href="grafica.php" class="card-link">Gráfico</a>
