...
<div class="col-xs-12">
  ...
  <!-- <p> Mostrar cantidad de <select name="sel" id="value"> 
    ...
    <button type="button" class="btn btn-success" data-toggle="modal" data-target="#create">
				<span class="glyphicon glyphicon-plus"></span> Nueva reserva   <i class="fa fa-plus"></i> </a></button>
      ...
      <i class="fa fa-power-off" aria-hidden="true"></i>
       ...
       <a href="grafica2.php" class="btn btn-primary"><b>Grafica</b> </a>
...
$conexion=mysqli_connect("localhost","root","","waiky");               
$SQL=mysqli_query($conexion,"SELECT user.id, user.nombre, user.apellidos,user.celular, user.correo, 
